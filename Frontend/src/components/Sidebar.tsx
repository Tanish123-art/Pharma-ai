...
import { Plus, Search, MoreVertical, Trash2, PanelLeft, Settings, LogOut, Moon } from 'lucide-react';
...
export default function Sidebar({ sessions, activeSessionId, onSelectSession, onNewChat, onSettings, onDeleteSession, onClearAll, onToggle, onLogout }: SidebarProps) {
    const { user } = useAuth();
    useTheme(); // Dark mode is always active
                ...
                {isProfileMenuOpen && (
                    ...
                    >
                        ...
                        <nav className="space-y-0.5">
                            ...
                            <div className="w-full px-3 py-2.5 my-1 text-sm bg-slate-900/50 rounded-lg flex items-center space-x-2 border border-white/5">
